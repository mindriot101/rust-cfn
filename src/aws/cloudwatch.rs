...
pub struct AnomalyDetectorProperties {
    ...
    pub metric_math_anomaly_detector:
        Option<crate::Value<self::anomaly_detector::MetricMathAnomalyDetector>>,
    ...
    pub single_metric_anomaly_detector:
        Option<crate::Value<self::anomaly_detector::SingleMetricAnomalyDetector>>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub stat: Option<crate::Value<String>>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut configuration: Option<crate::Value<self::anomaly_detector::Configuration>> =
                    None;
                ...
                let mut metric_math_anomaly_detector: Option<
                    crate::Value<self::anomaly_detector::MetricMathAnomalyDetector>,
                > = None;
                let mut metric_name: Option<crate::Value<String>> = None;
                let mut namespace: Option<crate::Value<String>> = None;
                let mut single_metric_anomaly_detector: Option<
                    crate::Value<self::anomaly_detector::SingleMetricAnomalyDetector>,
                > = None;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut exclude_filters: Option<
                    crate::ValueList<self::metric_stream::MetricStreamFilter>,
                > = None;
...
pub mod anomaly_detector {
    ...
    impl crate::codec::SerializeValue for MetricDataQueries {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
    ...
    impl crate::codec::DeserializeValue for MetricDataQueries {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
    ...
    pub struct MetricMathAnomalyDetector {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub metric_data_queries: Option<crate::ValueList<MetricDataQuery>>,
    }

    impl crate::codec::SerializeValue for MetricMathAnomalyDetector {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for MetricMathAnomalyDetector {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
    ...
    impl crate::codec::SerializeValue for SingleMetricAnomalyDetector {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref dimensions) = self.dimensions {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "Dimensions", dimensions)?;
    ...
    impl crate::codec::DeserializeValue for SingleMetricAnomalyDetector {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
