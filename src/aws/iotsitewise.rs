...
impl<'de> ::serde::Deserialize<'de> for AccessPolicyProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<AccessPolicyProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut access_policy_identity: Option<
                    crate::Value<self::access_policy::AccessPolicyIdentity>,
                > = None;
                let mut access_policy_permission: Option<crate::Value<String>> = None;
                let mut access_policy_resource: Option<
                    crate::Value<self::access_policy::AccessPolicyResource>,
                > = None;
                ...
                Ok(AccessPolicyProperties {
                    access_policy_identity: access_policy_identity
                        .ok_or(::serde::de::Error::missing_field("AccessPolicyIdentity"))?,
                    access_policy_permission: access_policy_permission
                        .ok_or(::serde::de::Error::missing_field("AccessPolicyPermission"))?,
                    access_policy_resource: access_policy_resource
                        .ok_or(::serde::de::Error::missing_field("AccessPolicyResource"))?,
                })
            }
        }
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(AssetProperties {
                    ...
                    asset_model_id: asset_model_id
                        .ok_or(::serde::de::Error::missing_field("AssetModelId"))?,
...
pub struct AssetModelProperties {
    ...
    pub asset_model_composite_models:
        Option<crate::ValueList<self::asset_model::AssetModelCompositeModel>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<AssetModelProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut asset_model_composite_models: Option<
                    crate::ValueList<self::asset_model::AssetModelCompositeModel>,
                > = None;
                let mut asset_model_description: Option<crate::Value<String>> = None;
                let mut asset_model_hierarchies: Option<
                    crate::ValueList<self::asset_model::AssetModelHierarchy>,
                > = None;
                let mut asset_model_name: Option<crate::Value<String>> = None;
                let mut asset_model_properties: Option<
                    crate::ValueList<self::asset_model::AssetModelProperty>,
                > = None;
                let mut tags: Option<crate::ValueList<crate::Tag>> = None;
                ...
                Ok(AssetModelProperties {
                    ...
                    asset_model_name: asset_model_name
                        .ok_or(::serde::de::Error::missing_field("AssetModelName"))?,
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(DashboardProperties {
                    dashboard_definition: dashboard_definition
                        .ok_or(::serde::de::Error::missing_field("DashboardDefinition"))?,
                    dashboard_description: dashboard_description
                        .ok_or(::serde::de::Error::missing_field("DashboardDescription"))?,
                    dashboard_name: dashboard_name
                        .ok_or(::serde::de::Error::missing_field("DashboardName"))?,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<GatewayProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut gateway_capability_summaries: Option<
                    crate::ValueList<self::gateway::GatewayCapabilitySummary>,
                > = None;
                ...
                Ok(GatewayProperties {
                    ...
                    gateway_name: gateway_name
                        .ok_or(::serde::de::Error::missing_field("GatewayName"))?,
                    gateway_platform: gateway_platform
                        .ok_or(::serde::de::Error::missing_field("GatewayPlatform"))?,
                    tags: tags,
                })
            }
        }
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(PortalProperties {
                    ...
                    portal_contact_email: portal_contact_email
                        .ok_or(::serde::de::Error::missing_field("PortalContactEmail"))?,
                    portal_description: portal_description,
                    portal_name: portal_name
                        .ok_or(::serde::de::Error::missing_field("PortalName"))?,
...
pub struct ProjectProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub asset_ids: Option<crate::ValueList<String>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ProjectProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut asset_ids: Option<crate::ValueList<String>> = None;
...
pub mod access_policy {
    ...
    impl crate::codec::DeserializeValue for AccessPolicyIdentity {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AccessPolicyIdentity, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for AccessPolicyResource {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AccessPolicyResource, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(AssetHierarchy {
                        child_asset_id: child_asset_id
                            .ok_or(::serde::de::Error::missing_field("ChildAssetId"))?,
                        logical_id: logical_id
                            .ok_or(::serde::de::Error::missing_field("LogicalId"))?,
                    })
                }
            }
...
pub mod asset_model {
    ...
    impl crate::codec::DeserializeValue for AssetModelCompositeModel {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AssetModelCompositeModel, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut composite_model_properties: Option<crate::ValueList<AssetModelProperty>> =
                        None;
    ...
    impl crate::codec::DeserializeValue for AssetModelHierarchy {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AssetModelHierarchy, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(AssetModelHierarchy {
                        child_asset_model_id: child_asset_model_id
                            .ok_or(::serde::de::Error::missing_field("ChildAssetModelId"))?,
                        logical_id: logical_id
                            .ok_or(::serde::de::Error::missing_field("LogicalId"))?,
                        name: name.ok_or(::serde::de::Error::missing_field("Name"))?,
                    })
    ...
    impl crate::codec::DeserializeValue for AssetModelProperty {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AssetModelProperty, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(AssetModelProperty {
                        data_type: data_type
                            .ok_or(::serde::de::Error::missing_field("DataType"))?,
    ...
    impl crate::codec::DeserializeValue for ExpressionVariable {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ExpressionVariable, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Metric {
                        ...
                        variables: variables
                            .ok_or(::serde::de::Error::missing_field("Variables"))?,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<MetricWindow, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(MetricWindow { tumbling: tumbling })
                }
            }
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(PropertyType {
                        ...
                        transform: transform,
                        type_name: type_name
                            .ok_or(::serde::de::Error::missing_field("TypeName"))?,
                    })
                }
            }
    ...
    pub struct TumblingWindow {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub offset: Option<crate::Value<String>>,
    }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut offset: Option<crate::Value<String>> = None;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(VariableValue {
                        ...
                        property_logical_id: property_logical_id
                            .ok_or(::serde::de::Error::missing_field("PropertyLogicalId"))?,
                    })
                }
            }
...
pub mod gateway {
    ...
    impl crate::codec::DeserializeValue for GatewayCapabilitySummary {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<GatewayCapabilitySummary, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(GatewayCapabilitySummary {
                        ...
                        capability_namespace: capability_namespace
                            .ok_or(::serde::de::Error::missing_field("CapabilityNamespace"))?,
                    })
                }
            }
    ...
    pub struct GatewayPlatform {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub greengrass: Option<crate::Value<Greengrass>>,
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub greengrass_v2: Option<crate::Value<GreengrassV2>>,
    }
    ...
    impl crate::codec::DeserializeValue for GatewayPlatform {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<GatewayPlatform, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut greengrass_v2: Option<crate::Value<GreengrassV2>> = None;
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Greengrass, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Greengrass {
                        group_arn: group_arn
                            .ok_or(::serde::de::Error::missing_field("GroupArn"))?,
                    })
                }
            }
    ...
    pub struct GreengrassV2 {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub core_device_thing_name: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for GreengrassV2 {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for GreengrassV2 {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<GreengrassV2, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut core_device_thing_name: Option<crate::Value<String>> = None;
                    ...
                    Ok(GreengrassV2 {
                        core_device_thing_name: core_device_thing_name
                            .ok_or(::serde::de::Error::missing_field("CoreDeviceThingName"))?,
                    })
                }
            }
