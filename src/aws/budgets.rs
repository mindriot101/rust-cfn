...
pub struct BudgetProperties {
    ...
    pub notifications_with_subscribers:
        Option<crate::ValueList<self::budget::NotificationWithSubscribers>>,
}
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut notifications_with_subscribers: Option<
                    crate::ValueList<self::budget::NotificationWithSubscribers>,
                > = None;
...
pub struct BudgetsActionProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub subscribers: crate::ValueList<self::budgets_action::Subscriber>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut action_threshold: Option<crate::Value<self::budgets_action::ActionThreshold>> =
                    None;
