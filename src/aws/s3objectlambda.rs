...
pub struct AccessPointProperties {
    ...
    pub object_lambda_configuration: crate::Value<self::access_point::ObjectLambdaConfiguration>,
}
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut object_lambda_configuration: Option<
                    crate::Value<self::access_point::ObjectLambdaConfiguration>,
                > = None;
...
pub mod access_point {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut transformation_configurations: Option<
                        crate::ValueList<TransformationConfiguration>,
                    > = None;
    ...
    pub struct TransformationConfiguration {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub content_transformation: crate::Value<crate::json::Value>,
    }
