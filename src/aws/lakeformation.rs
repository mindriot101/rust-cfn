    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<PermissionsProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut data_lake_principal: Option<crate::Value<self::permissions::DataLakePrincipal>> =
                    None;
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Resource, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut table_with_columns_resource: Option<crate::Value<TableWithColumnsResource>> =
                        None;
