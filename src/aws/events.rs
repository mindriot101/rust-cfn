...
impl<'de> ::serde::Deserialize<'de> for ApiDestinationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<ApiDestinationProperties, D::Error> {
        struct Visitor;
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(ApiDestinationProperties {
                    connection_arn: connection_arn
                        .ok_or(::serde::de::Error::missing_field("ConnectionArn"))?,
                    description: description,
                    http_method: http_method
                        .ok_or(::serde::de::Error::missing_field("HttpMethod"))?,
                    invocation_endpoint: invocation_endpoint
                        .ok_or(::serde::de::Error::missing_field("InvocationEndpoint"))?,
...
pub struct ConnectionProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub auth_parameters: crate::Value<self::connection::AuthParameters>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ConnectionProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut auth_parameters: Option<crate::Value<self::connection::AuthParameters>> = None;
                ...
                Ok(ConnectionProperties {
                    auth_parameters: auth_parameters
                        .ok_or(::serde::de::Error::missing_field("AuthParameters"))?,
                    authorization_type: authorization_type
                        .ok_or(::serde::de::Error::missing_field("AuthorizationType"))?,
                    description: description,
                    name: name,
                })
            }
...
pub struct EndpointProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub event_buses: crate::ValueList<self::endpoint::EndpointEventBus>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub replication_config: Option<crate::Value<self::endpoint::ReplicationConfig>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub routing_config: crate::Value<self::endpoint::RoutingConfig>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<EndpointProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut description: Option<crate::Value<String>> = None;
                let mut event_buses: Option<crate::ValueList<self::endpoint::EndpointEventBus>> = None;
                let mut name: Option<crate::Value<String>> = None;
                let mut replication_config: Option<crate::Value<self::endpoint::ReplicationConfig>> =
                    None;
                let mut role_arn: Option<crate::Value<String>> = None;
                let mut routing_config: Option<crate::Value<self::endpoint::RoutingConfig>> = None;
                ...
                Ok(EndpointProperties {
                    ...
                    event_buses: event_buses
                        .ok_or(::serde::de::Error::missing_field("EventBuses"))?,
                    name: name.ok_or(::serde::de::Error::missing_field("Name"))?,
                    replication_config: replication_config,
                    role_arn: role_arn,
                    routing_config: routing_config
                        .ok_or(::serde::de::Error::missing_field("RoutingConfig"))?,
                })
            }
        }
...
pub struct EventBusProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub tags: Option<crate::ValueList<self::event_bus::TagEntry>>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<EventBusProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut name: Option<crate::Value<String>> = None;
                let mut tags: Option<crate::ValueList<self::event_bus::TagEntry>> = None;
...
impl<'de> ::serde::Deserialize<'de> for EventBusPolicyProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<EventBusPolicyProperties, D::Error> {
        struct Visitor;
...
pub mod connection {
    ...
    pub struct ApiKeyAuthParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub api_key_name: crate::Value<String>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub api_key_value: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for ApiKeyAuthParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for ApiKeyAuthParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ApiKeyAuthParameters, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut api_key_name: Option<crate::Value<String>> = None;
                    let mut api_key_value: Option<crate::Value<String>> = None;
                    ...
                    Ok(ApiKeyAuthParameters {
                        api_key_name: api_key_name
                            .ok_or(::serde::de::Error::missing_field("ApiKeyName"))?,
                        api_key_value: api_key_value
                            .ok_or(::serde::de::Error::missing_field("ApiKeyValue"))?,
                    })
                }
            }
    ...
    pub struct AuthParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub api_key_auth_parameters: Option<crate::Value<ApiKeyAuthParameters>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub basic_auth_parameters: Option<crate::Value<BasicAuthParameters>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub invocation_http_parameters: Option<crate::Value<ConnectionHttpParameters>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub o_auth_parameters: Option<crate::Value<OAuthParameters>>,
    }

    impl crate::codec::SerializeValue for AuthParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for AuthParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AuthParameters, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut api_key_auth_parameters: Option<crate::Value<ApiKeyAuthParameters>> = None;
                    let mut basic_auth_parameters: Option<crate::Value<BasicAuthParameters>> = None;
                    let mut invocation_http_parameters: Option<crate::Value<ConnectionHttpParameters>> =
                        None;
                    let mut o_auth_parameters: Option<crate::Value<OAuthParameters>> = None;
    ...
    impl crate::codec::SerializeValue for BasicAuthParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for BasicAuthParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<BasicAuthParameters, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::SerializeValue for ClientParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for ClientParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ClientParameters, D::Error> {
            struct Visitor;
    ...
    pub struct ConnectionHttpParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub body_parameters: Option<crate::ValueList<Parameter>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub header_parameters: Option<crate::ValueList<Parameter>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub query_string_parameters: Option<crate::ValueList<Parameter>>,
    }

    impl crate::codec::SerializeValue for ConnectionHttpParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for ConnectionHttpParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ConnectionHttpParameters, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut body_parameters: Option<crate::ValueList<Parameter>> = None;
                    let mut header_parameters: Option<crate::ValueList<Parameter>> = None;
                    let mut query_string_parameters: Option<crate::ValueList<Parameter>> = None;
    ...
    pub struct OAuthParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub client_parameters: crate::Value<ClientParameters>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub o_auth_http_parameters: Option<crate::Value<ConnectionHttpParameters>>,
    }

    impl crate::codec::SerializeValue for OAuthParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for OAuthParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<OAuthParameters, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut client_parameters: Option<crate::Value<ClientParameters>> = None;
                    let mut http_method: Option<crate::Value<String>> = None;
                    let mut o_auth_http_parameters: Option<crate::Value<ConnectionHttpParameters>> =
                        None;
                    ...
                    Ok(OAuthParameters {
                        authorization_endpoint: authorization_endpoint
                            .ok_or(::serde::de::Error::missing_field("AuthorizationEndpoint"))?,
                        client_parameters: client_parameters
                            .ok_or(::serde::de::Error::missing_field("ClientParameters"))?,
                        http_method: http_method
                            .ok_or(::serde::de::Error::missing_field("HttpMethod"))?,
    ...
    pub struct Parameter {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub is_value_secret: Option<crate::Value<bool>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Parameter, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut is_value_secret: Option<crate::Value<bool>> = None;
...
pub mod endpoint {
    ...
    pub struct EndpointEventBus {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub event_bus_arn: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for EndpointEventBus {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for EndpointEventBus {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<EndpointEventBus, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut event_bus_arn: Option<crate::Value<String>> = None;
                    ...
                    Ok(EndpointEventBus {
                        event_bus_arn: event_bus_arn
                            .ok_or(::serde::de::Error::missing_field("EventBusArn"))?,
                    })
                }
            }
    ...
    pub struct FailoverConfig {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub primary: crate::Value<Primary>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub secondary: crate::Value<Secondary>,
    }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut primary: Option<crate::Value<Primary>> = None;
                    let mut secondary: Option<crate::Value<Secondary>> = None;
                    ...
                    Ok(FailoverConfig {
                        ...
                        secondary: secondary
                            .ok_or(::serde::de::Error::missing_field("Secondary"))?,
                    })
                }
            }
    ...
    pub struct Primary {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub health_check: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for Primary {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for Primary {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Primary, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut health_check: Option<crate::Value<String>> = None;
                    ...
                    Ok(Primary {
                        health_check: health_check
                            .ok_or(::serde::de::Error::missing_field("HealthCheck"))?,
                    })
                }
            }
    ...
    pub struct ReplicationConfig {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub state: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for ReplicationConfig {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for ReplicationConfig {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ReplicationConfig, D::Error> {
            struct Visitor;
    ...
    pub struct RoutingConfig {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub failover_config: crate::Value<FailoverConfig>,
    }

    impl crate::codec::SerializeValue for RoutingConfig {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for RoutingConfig {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<RoutingConfig, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut failover_config: Option<crate::Value<FailoverConfig>> = None;
                    ...
                    Ok(RoutingConfig {
                        failover_config: failover_config
                            .ok_or(::serde::de::Error::missing_field("FailoverConfig"))?,
                    })
                }
            }
    ...
    pub struct Secondary {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub route: crate::Value<String>,
    }

    impl crate::codec::SerializeValue for Secondary {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for Secondary {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Secondary, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut route: Option<crate::Value<String>> = None;
...
pub mod event_bus {
    ...
    impl crate::codec::SerializeValue for TagEntry {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Key", &self.key)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Value", &self.value)?;
    ...
    impl crate::codec::DeserializeValue for TagEntry {
...
pub mod rule {
    ...
    impl crate::codec::DeserializeValue for AwsVpcConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<AwsVpcConfiguration, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for BatchArrayProperties {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<BatchArrayProperties, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(BatchArrayProperties { size: size })
                }
            }
    ...
    impl crate::codec::DeserializeValue for BatchParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<BatchParameters, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(BatchParameters {
                        ...
                        job_definition: job_definition
                            .ok_or(::serde::de::Error::missing_field("JobDefinition"))?,
    ...
    impl crate::codec::DeserializeValue for BatchRetryStrategy {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<BatchRetryStrategy, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(BatchRetryStrategy { attempts: attempts })
                }
            }
    ...
    impl crate::codec::DeserializeValue for CapacityProviderStrategyItem {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<CapacityProviderStrategyItem, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(CapacityProviderStrategyItem {
                        ...
                        capacity_provider: capacity_provider
                            .ok_or(::serde::de::Error::missing_field("CapacityProvider"))?,
                        weight: weight,
                    })
                }
            }
    ...
    impl crate::codec::DeserializeValue for DeadLetterConfig {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<DeadLetterConfig, D::Error> {
            struct Visitor;
    ...
    pub struct EcsParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub capacity_provider_strategy: Option<crate::ValueList<CapacityProviderStrategyItem>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub placement_constraints: Option<crate::ValueList<PlacementConstraint>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub placement_strategies: Option<crate::ValueList<PlacementStrategy>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub reference_id: Option<crate::Value<String>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub tag_list: Option<crate::ValueList<crate::Tag>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut capacity_provider_strategy: Option<
                        crate::ValueList<CapacityProviderStrategyItem>,
                    > = None;
                    ...
                    let mut placement_constraints: Option<crate::ValueList<PlacementConstraint>> = None;
                    let mut placement_strategies: Option<crate::ValueList<PlacementStrategy>> = None;
                    let mut platform_version: Option<crate::Value<String>> = None;
                    let mut propagate_tags: Option<crate::Value<String>> = None;
                    let mut reference_id: Option<crate::Value<String>> = None;
                    let mut tag_list: Option<crate::ValueList<crate::Tag>> = None;
                    ...
                    Ok(EcsParameters {
                        ...
                        task_definition_arn: task_definition_arn
                            .ok_or(::serde::de::Error::missing_field("TaskDefinitionArn"))?,
                    })
                }
            }
    ...
    impl crate::codec::DeserializeValue for InputTransformer {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<InputTransformer, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(InputTransformer {
                        ...
                        input_template: input_template
                            .ok_or(::serde::de::Error::missing_field("InputTemplate"))?,
                    })
                }
            }
    ...
    impl crate::codec::DeserializeValue for KinesisParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<KinesisParameters, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(KinesisParameters {
                        partition_key_path: partition_key_path
                            .ok_or(::serde::de::Error::missing_field("PartitionKeyPath"))?,
                    })
                }
            }
    ...
    impl crate::codec::DeserializeValue for PlacementConstraint {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<PlacementConstraint, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for PlacementStrategy {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<PlacementStrategy, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for RedshiftDataParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<RedshiftDataParameters, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for RunCommandParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<RunCommandParameters, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(RunCommandParameters {
                        run_command_targets: run_command_targets
                            .ok_or(::serde::de::Error::missing_field("RunCommandTargets"))?,
                    })
                }
            }
    ...
    impl crate::codec::DeserializeValue for RunCommandTarget {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<RunCommandTarget, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::SerializeValue for SageMakerPipelineParameter {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Name", &self.name)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Value", &self.value)?;
    ...
    impl crate::codec::DeserializeValue for SageMakerPipelineParameter {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<SageMakerPipelineParameter, D::Error> {
            struct Visitor;
    ...
    pub struct SageMakerPipelineParameters {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub pipeline_parameter_list: Option<crate::ValueList<SageMakerPipelineParameter>>,
    }

    impl crate::codec::SerializeValue for SageMakerPipelineParameters {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for SageMakerPipelineParameters {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<SageMakerPipelineParameters, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut pipeline_parameter_list: Option<
                        crate::ValueList<SageMakerPipelineParameter>,
                    > = None;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(SqsParameters {
                        message_group_id: message_group_id
                            .ok_or(::serde::de::Error::missing_field("MessageGroupId"))?,
                    })
                }
            }
    ...
    impl crate::codec::SerializeValue for Tag {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref key) = self.key {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "Key", key)?;
    ...
    impl crate::codec::DeserializeValue for Tag {
    ...
    pub struct Target {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub sage_maker_pipeline_parameters: Option<crate::Value<SageMakerPipelineParameters>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Target, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut redshift_data_parameters: Option<crate::Value<RedshiftDataParameters>> =
                        None;
                    ...
                    let mut sage_maker_pipeline_parameters: Option<
                        crate::Value<SageMakerPipelineParameters>,
                    > = None;
