    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<BackupPlanProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut backup_plan: Option<crate::Value<self::backup_plan::BackupPlanResourceType>> =
                    None;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut backup_selection: Option<
                    crate::Value<self::backup_selection::BackupSelectionResourceType>,
                > = None;
...
pub struct BackupVaultProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub lock_configuration: Option<crate::Value<self::backup_vault::LockConfigurationType>>,
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut lock_configuration: Option<
                    crate::Value<self::backup_vault::LockConfigurationType>,
                > = None;
                let mut notifications: Option<crate::Value<self::backup_vault::NotificationObjectType>> =
                    None;
...
pub struct FrameworkProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub framework_controls: crate::ValueList<self::framework::FrameworkControl>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub framework_description: Option<crate::Value<String>>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub framework_name: Option<crate::Value<String>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub framework_tags: Option<crate::ValueList<crate::Tag>>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<FrameworkProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut framework_controls: Option<crate::ValueList<self::framework::FrameworkControl>> =
                    None;
                let mut framework_description: Option<crate::Value<String>> = None;
                let mut framework_name: Option<crate::Value<String>> = None;
                let mut framework_tags: Option<crate::ValueList<crate::Tag>> = None;
...
impl crate::Resource for Framework {
...
impl crate::private::Sealed for Framework {}
...
pub struct ReportPlanProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub report_delivery_channel: crate::Value<crate::json::Value>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub report_plan_description: Option<crate::Value<String>>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub report_plan_name: Option<crate::Value<String>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub report_plan_tags: Option<crate::ValueList<crate::Tag>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub report_setting: crate::Value<crate::json::Value>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ReportPlanProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut report_delivery_channel: Option<crate::Value<crate::json::Value>> = None;
                let mut report_plan_description: Option<crate::Value<String>> = None;
                let mut report_plan_name: Option<crate::Value<String>> = None;
                let mut report_plan_tags: Option<crate::ValueList<crate::Tag>> = None;
                let mut report_setting: Option<crate::Value<crate::json::Value>> = None;
...
impl crate::Resource for ReportPlan {
...
impl crate::private::Sealed for ReportPlan {}
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut advanced_backup_settings: Option<
                        crate::ValueList<AdvancedBackupSettingResourceType>,
                    > = None;
...
pub mod backup_selection {
    ...
    pub struct BackupSelectionResourceType {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub conditions: Option<crate::Value<crate::json::Value>>,
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub not_resources: Option<crate::ValueList<String>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut conditions: Option<crate::Value<crate::json::Value>> = None;
                    ...
                    let mut not_resources: Option<crate::ValueList<String>> = None;
...
pub mod backup_vault {
    ...
    pub struct LockConfigurationType {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub changeable_for_days: Option<crate::Value<f64>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub max_retention_days: Option<crate::Value<f64>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub min_retention_days: crate::Value<f64>,
    }

    impl crate::codec::SerializeValue for LockConfigurationType {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for LockConfigurationType {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut changeable_for_days: Option<crate::Value<f64>> = None;
                    let mut max_retention_days: Option<crate::Value<f64>> = None;
                    let mut min_retention_days: Option<crate::Value<f64>> = None;
...
pub mod framework {
    ...
    impl crate::codec::SerializeValue for ControlInputParameter {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(
                &mut map,
    ...
    impl crate::codec::DeserializeValue for ControlInputParameter {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
    ...
    pub struct FrameworkControl {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub control_input_parameters: Option<crate::ValueList<ControlInputParameter>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub control_name: crate::Value<String>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub control_scope: Option<crate::Value<crate::json::Value>>,
    }

    impl crate::codec::SerializeValue for FrameworkControl {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for FrameworkControl {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut control_input_parameters: Option<crate::ValueList<ControlInputParameter>> =
                        None;
                    let mut control_name: Option<crate::Value<String>> = None;
                    let mut control_scope: Option<crate::Value<crate::json::Value>> = None;
