            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(CertificateProperties {
                    ...
                    certificate_authority_arn: certificate_authority_arn
                        .ok_or(::serde::de::Error::missing_field("CertificateAuthorityArn"))?,
                    certificate_signing_request: certificate_signing_request.ok_or(
                        ::serde::de::Error::missing_field("CertificateSigningRequest"),
                    )?,
                    signing_algorithm: signing_algorithm
                        .ok_or(::serde::de::Error::missing_field("SigningAlgorithm"))?,
...
impl<'de> ::serde::Deserialize<'de> for CertificateAuthorityProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<CertificateAuthorityProperties, D::Error> {
        struct Visitor;
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(CertificateAuthorityProperties {
                    ...
                    key_algorithm: key_algorithm
                        .ok_or(::serde::de::Error::missing_field("KeyAlgorithm"))?,
...
impl<'de> ::serde::Deserialize<'de> for CertificateAuthorityActivationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<CertificateAuthorityActivationProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(
                    f,
                    "a struct of type CertificateAuthorityActivationProperties"
                )
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(CustomAttribute {
                        object_identifier: object_identifier
                            .ok_or(::serde::de::Error::missing_field("ObjectIdentifier"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(EdiPartyName {
                        name_assigner: name_assigner
                            .ok_or(::serde::de::Error::missing_field("NameAssigner"))?,
                        party_name: party_name
                            .ok_or(::serde::de::Error::missing_field("PartyName"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(PolicyInformation {
                        cert_policy_id: cert_policy_id
                            .ok_or(::serde::de::Error::missing_field("CertPolicyId"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(PolicyQualifierInfo {
                        policy_qualifier_id: policy_qualifier_id
                            .ok_or(::serde::de::Error::missing_field("PolicyQualifierId"))?,
                        qualifier: qualifier
                            .ok_or(::serde::de::Error::missing_field("Qualifier"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(AccessDescription {
                        access_location: access_location
                            .ok_or(::serde::de::Error::missing_field("AccessLocation"))?,
                        access_method: access_method
                            .ok_or(::serde::de::Error::missing_field("AccessMethod"))?,
                    })
                }
            }
