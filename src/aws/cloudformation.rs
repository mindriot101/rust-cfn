...
impl<'de> ::serde::Deserialize<'de> for CustomResourceProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<CustomResourceProperties, D::Error> {
        struct Visitor;
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(CustomResourceProperties {
                    service_token: service_token
                        .ok_or(::serde::de::Error::missing_field("ServiceToken"))?,
                })
            }
        }
...
impl<'de> ::serde::Deserialize<'de> for HookDefaultVersionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<HookDefaultVersionProperties, D::Error> {
        struct Visitor;
...
impl crate::Resource for HookDefaultVersion {
...
impl crate::private::Sealed for HookDefaultVersion {}
...
pub struct HookTypeConfigProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub configuration: crate::Value<String>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub configuration_alias: Option<crate::Value<String>>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub type_arn: Option<crate::Value<String>>,
...
impl<'de> ::serde::Deserialize<'de> for HookTypeConfigProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<HookTypeConfigProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut configuration_alias: Option<crate::Value<String>> = None;
                let mut type_arn: Option<crate::Value<String>> = None;
                let mut type_name: Option<crate::Value<String>> = None;
...
impl crate::Resource for HookTypeConfig {
...
impl crate::private::Sealed for HookTypeConfig {}
...
pub struct HookVersionProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub logging_config: Option<crate::Value<self::hook_version::LoggingConfig>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<HookVersionProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut logging_config: Option<crate::Value<self::hook_version::LoggingConfig>> = None;
                ...
                Ok(HookVersionProperties {
                    ...
                    schema_handler_package: schema_handler_package
                        .ok_or(::serde::de::Error::missing_field("SchemaHandlerPackage"))?,
...
impl crate::Resource for HookVersion {
...
impl crate::private::Sealed for HookVersion {}
...
impl<'de> ::serde::Deserialize<'de> for ModuleDefaultVersionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<ModuleDefaultVersionProperties, D::Error> {
        struct Visitor;
...
impl<'de> ::serde::Deserialize<'de> for ModuleVersionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<ModuleVersionProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(ModuleVersionProperties {
                    module_name: module_name
                        .ok_or(::serde::de::Error::missing_field("ModuleName"))?,
                    module_package: module_package
                        .ok_or(::serde::de::Error::missing_field("ModulePackage"))?,
                })
            }
        }
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(PublisherProperties {
                    accept_terms_and_conditions: accept_terms_and_conditions.ok_or(
                        ::serde::de::Error::missing_field("AcceptTermsAndConditions"),
                    )?,
...
impl<'de> ::serde::Deserialize<'de> for ResourceDefaultVersionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<ResourceDefaultVersionProperties, D::Error> {
        struct Visitor;
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut execution_role_arn: Option<crate::Value<String>> = None;
                let mut logging_config: Option<crate::Value<self::resource_version::LoggingConfig>> =
                    None;
                let mut schema_handler_package: Option<crate::Value<String>> = None;
                let mut type_name: Option<crate::Value<String>> = None;
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(StackProperties {
                    ...
                    template_url: template_url
                        .ok_or(::serde::de::Error::missing_field("TemplateURL"))?,
...
pub struct StackSetProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub managed_execution: Option<crate::Value<crate::json::Value>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<StackSetProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut managed_execution: Option<crate::Value<crate::json::Value>> = None;
                let mut operation_preferences: Option<
                    crate::Value<self::stack_set::OperationPreferences>,
                > = None;
                ...
                let mut stack_instances_group: Option<
                    crate::ValueList<self::stack_set::StackInstances>,
                > = None;
                ...
                Ok(StackSetProperties {
                    ...
                    permission_model: permission_model
                        .ok_or(::serde::de::Error::missing_field("PermissionModel"))?,
                    stack_instances_group: stack_instances_group,
                    stack_set_name: stack_set_name
                        .ok_or(::serde::de::Error::missing_field("StackSetName"))?,
                    tags: tags,
...
impl<'de> ::serde::Deserialize<'de> for TypeActivationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<TypeActivationProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut execution_role_arn: Option<crate::Value<String>> = None;
                let mut logging_config: Option<crate::Value<self::type_activation::LoggingConfig>> =
                    None;
...
impl<'de> ::serde::Deserialize<'de> for WaitConditionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<WaitConditionProperties, D::Error> {
        struct Visitor;
...
impl<'de> ::serde::Deserialize<'de> for WaitConditionHandleProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<WaitConditionHandleProperties, D::Error> {
        struct Visitor;
...
pub mod stack_set {
    ...
    impl crate::codec::SerializeValue for AutoDeployment {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            ...
            if let Some(ref retain_stacks_on_account_removal) =
    ...
    impl crate::codec::DeserializeValue for DeploymentTargets {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<DeploymentTargets, D::Error> {
            struct Visitor;
    ...
    impl crate::codec::DeserializeValue for OperationPreferences {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<OperationPreferences, D::Error> {
            struct Visitor;
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Parameter {
                        parameter_key: parameter_key
                            .ok_or(::serde::de::Error::missing_field("ParameterKey"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(StackInstances {
                        deployment_targets: deployment_targets
                            .ok_or(::serde::de::Error::missing_field("DeploymentTargets"))?,
