    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<DetectorProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut data_sources: Option<crate::Value<self::detector::CFNDataSourceConfigurations>> =
                    None;
...
pub mod detector {
    ...
    pub struct CFNDataSourceConfigurations {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub kubernetes: Option<crate::Value<CFNKubernetesConfiguration>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut kubernetes: Option<crate::Value<CFNKubernetesConfiguration>> = None;
    ...
    impl crate::codec::SerializeValue for CFNKubernetesAuditLogsConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for CFNKubernetesAuditLogsConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
    ...
    pub struct CFNKubernetesConfiguration {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub audit_logs: Option<crate::Value<CFNKubernetesAuditLogsConfiguration>>,
    }

    impl crate::codec::SerializeValue for CFNKubernetesConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl crate::codec::DeserializeValue for CFNKubernetesConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut audit_logs: Option<crate::Value<CFNKubernetesAuditLogsConfiguration>> = None;
