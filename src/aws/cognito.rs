...
pub struct IdentityPoolProperties {
    ...
    pub cognito_identity_providers:
        Option<crate::ValueList<self::identity_pool::CognitoIdentityProvider>>,
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut cognito_identity_providers: Option<
                    crate::ValueList<self::identity_pool::CognitoIdentityProvider>,
                > = None;
                let mut cognito_streams: Option<crate::Value<self::identity_pool::CognitoStreams>> =
                    None;
...
pub struct UserPoolProperties {
    ...
    pub verification_message_template:
        Option<crate::Value<self::user_pool::VerificationMessageTemplate>>,
}
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut account_recovery_setting: Option<
                    crate::Value<self::user_pool::AccountRecoverySetting>,
                > = None;
                let mut admin_create_user_config: Option<
                    crate::Value<self::user_pool::AdminCreateUserConfig>,
                > = None;
                ...
                let mut device_configuration: Option<
                    crate::Value<self::user_pool::DeviceConfiguration>,
                > = None;
                let mut email_configuration: Option<crate::Value<self::user_pool::EmailConfiguration>> =
                    None;
                ...
                let mut sms_configuration: Option<crate::Value<self::user_pool::SmsConfiguration>> =
                    None;
                ...
                let mut username_configuration: Option<
                    crate::Value<self::user_pool::UsernameConfiguration>,
                > = None;
                let mut verification_message_template: Option<
                    crate::Value<self::user_pool::VerificationMessageTemplate>,
                > = None;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut analytics_configuration: Option<
                    crate::Value<self::user_pool_client::AnalyticsConfiguration>,
                > = None;
                ...
                let mut token_validity_units: Option<
                    crate::Value<self::user_pool_client::TokenValidityUnits>,
                > = None;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut custom_domain_config: Option<
                    crate::Value<self::user_pool_domain::CustomDomainConfigType>,
                > = None;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut scopes: Option<
                    crate::ValueList<self::user_pool_resource_server::ResourceServerScopeType>,
                > = None;
                let mut user_pool_id: Option<crate::Value<String>> = None;
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut user_attributes: Option<crate::ValueList<self::user_pool_user::AttributeType>> =
                    None;
                let mut user_pool_id: Option<crate::Value<String>> = None;
                let mut username: Option<crate::Value<String>> = None;
                let mut validation_data: Option<crate::ValueList<self::user_pool_user::AttributeType>> =
                    None;
...
pub mod user_pool {
    ...
    pub struct SmsConfiguration {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub sns_region: Option<crate::Value<String>>,
    }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut sns_region: Option<crate::Value<String>> = None;
