            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(ConnectorProperties {
                    ...
                    connector_configuration: connector_configuration
                        .ok_or(::serde::de::Error::missing_field("ConnectorConfiguration"))?,
                    connector_description: connector_description,
                    connector_name: connector_name
                        .ok_or(::serde::de::Error::missing_field("ConnectorName"))?,
                    kafka_cluster: kafka_cluster
                        .ok_or(::serde::de::Error::missing_field("KafkaCluster"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(ApacheKafkaCluster {
                        bootstrap_servers: bootstrap_servers
                            .ok_or(::serde::de::Error::missing_field("BootstrapServers"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(AutoScaling {
                        max_worker_count: max_worker_count
                            .ok_or(::serde::de::Error::missing_field("MaxWorkerCount"))?,
                        mcu_count: mcu_count
                            .ok_or(::serde::de::Error::missing_field("McuCount"))?,
                        min_worker_count: min_worker_count
                            .ok_or(::serde::de::Error::missing_field("MinWorkerCount"))?,
                        scale_in_policy: scale_in_policy
                            .ok_or(::serde::de::Error::missing_field("ScaleInPolicy"))?,
                        scale_out_policy: scale_out_policy
                            .ok_or(::serde::de::Error::missing_field("ScaleOutPolicy"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(CustomPlugin {
                        custom_plugin_arn: custom_plugin_arn
                            .ok_or(::serde::de::Error::missing_field("CustomPluginArn"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(KafkaCluster {
                        apache_kafka_cluster: apache_kafka_cluster
                            .ok_or(::serde::de::Error::missing_field("ApacheKafkaCluster"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(LogDelivery {
                        worker_log_delivery: worker_log_delivery
                            .ok_or(::serde::de::Error::missing_field("WorkerLogDelivery"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Plugin {
                        custom_plugin: custom_plugin
                            .ok_or(::serde::de::Error::missing_field("CustomPlugin"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(ProvisionedCapacity {
                        ...
                        worker_count: worker_count
                            .ok_or(::serde::de::Error::missing_field("WorkerCount"))?,
                    })
                }
            }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(ScaleInPolicy {
                        cpu_utilization_percentage: cpu_utilization_percentage.ok_or(
                            ::serde::de::Error::missing_field("CpuUtilizationPercentage"),
                        )?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Vpc {
                        security_groups: security_groups
                            .ok_or(::serde::de::Error::missing_field("SecurityGroups"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(WorkerConfiguration {
                        ...
                        worker_configuration_arn: worker_configuration_arn
                            .ok_or(::serde::de::Error::missing_field("WorkerConfigurationArn"))?,
                    })
                }
            }
