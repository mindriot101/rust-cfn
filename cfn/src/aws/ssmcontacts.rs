...
impl<'de> ::serde::Deserialize<'de> for ContactChannelProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<ContactChannelProperties, D::Error> {
        struct Visitor;
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                Ok(ContactChannelProperties {
                    channel_address: channel_address
                        .ok_or(::serde::de::Error::missing_field("ChannelAddress"))?,
                    channel_name: channel_name
                        .ok_or(::serde::de::Error::missing_field("ChannelName"))?,
                    channel_type: channel_type
                        .ok_or(::serde::de::Error::missing_field("ChannelType"))?,
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(ChannelTargetInfo {
                        channel_id: channel_id
                            .ok_or(::serde::de::Error::missing_field("ChannelId"))?,
                        retry_interval_in_minutes: retry_interval_in_minutes
                            .ok_or(::serde::de::Error::missing_field("RetryIntervalInMinutes"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(ContactTargetInfo {
                        contact_id: contact_id
                            .ok_or(::serde::de::Error::missing_field("ContactId"))?,
                        is_essential: is_essential
                            .ok_or(::serde::de::Error::missing_field("IsEssential"))?,
                    })
                }
            }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    Ok(Stage {
                        duration_in_minutes: duration_in_minutes
                            .ok_or(::serde::de::Error::missing_field("DurationInMinutes"))?,
                        targets: targets,
                    })
                }
            }
